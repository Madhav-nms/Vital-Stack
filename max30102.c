...
int max30102_init(void){
    ...
    i2c_write_reg(MAX30102_ADDR, REG_FIFO_CONFIG, 0x5F);
    ...
    // LED config (7.2mA)
    i2c_write_reg(MAX30102_ADDR, REG_LED1_PA, 0x24); // RED LED 
    i2c_write_reg(MAX30102_ADDR, REG_LED2_PA, 0x24); // IR LED 
    // Enable Interrupt (PPG_RDY page 12)
    i2c_write_reg(MAX30102_ADDR, REG_INT_ENABLE1, 0x40);
    ...
    i2c_write_reg(MAX30102_ADDR, REG_OVF_COUNTER,  0x00);
